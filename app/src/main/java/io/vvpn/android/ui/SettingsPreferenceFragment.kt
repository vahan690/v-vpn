...
import io.vvpn.android.ktx.needRestart
import io.vvpn.android.ktx.onMainDispatcher
import io.vvpn.android.utils.Theme
import io.vvpn.android.widget.ColorPickerPreference
import io.vvpn.android.widget.DurationPreference
import io.vvpn.android.widget.FixedLinearLayout
import io.vvpn.android.widget.LinkOrContentPreference
                    ...
                    when (preference.key) {
                        ...
                        Key.DISABLE_PROCESS_TEXT -> preference.setOnPreferenceChangeListener { _, newValue ->
                            preference.context.packageManager.setComponentEnabledSetting(
                                ComponentName(
                                    preference.context,
                                    "io.vvpn.android.ui.ProcessTextActivityAlias",
                                ),
