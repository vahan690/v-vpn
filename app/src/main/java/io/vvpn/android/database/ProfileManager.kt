...
import io.vvpn.android.fmt.SingBoxOptions.ACTION_HIJACK_DNS
import io.vvpn.android.fmt.SingBoxOptions.ACTION_SNIFF
import io.vvpn.android.fmt.SingBoxOptions.NetworkUDP
...
object ProfileManager {
    ...
    suspend fun createDefaultHysteria2Profile(groupId: Long): ProxyEntity {
        ...
        val bean = io.vvpn.android.fmt.hysteria.HysteriaBean().apply {
            protocolVersion = io.vvpn.android.fmt.hysteria.HysteriaBean.PROTOCOL_VERSION_2
