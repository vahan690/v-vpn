...
object Action {
    const val SERVICE = "io.vvpn.android.SERVICE"
    const val CLOSE = "io.vvpn.android.CLOSE"
    const val RELOAD = "io.vvpn.android.RELOAD"

    // const val SWITCH_WAKE_LOCK = "io.vvpn.android.SWITCH_WAKELOCK"
    const val RESET_UPSTREAM_CONNECTIONS = "io.vvpn.android.RESET_UPSTREAM_CONNECTIONS"
}
